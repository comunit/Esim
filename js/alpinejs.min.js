...
`
    ...
    function ut(e) {
        ...
        return (
            t.push(i),
            [
                { Alpine: F, effect: n, cleanup: r, evaluateLater: x.bind(x, e), evaluate: P.bind(P, e) },
                () => t.forEach((a) => a()),
            ]
        );
    }
    function En(e, t) {
        ...
        let s = () => {
            e._x_ignore ||
                e._x_ignoreSelf ||
                (n.inline && n.inline(e, t, i), (n = n.bind(n, e, t, i)), _t ? ce.get(or).push(n) : n());
        };
    ...
    function de(e, t, r, n = []) {
        switch (
            (e._x_bindings || (e._x_bindings = T({})), (e._x_bindings[t] = r), (t = n.includes("camel") ? Fn(t) : t), t)
        ) {
            case "value":
                kn(e, r);
                break;
    ...
    function kn(e, t) {
        if (e.type === "radio")
            e.attributes.value === void 0 && (e.value = t), window.fromModel && (e.checked = wr(e.value, t));
    ...
    function R(e, t, r) {
        ...
        i || n.set(r, (i = new Set())),
            i.has(D) ||
                (i.add(D),
                D.deps.push(i),
                D.options.onTrack && D.options.onTrack({ effect: D, target: e, type: t, key: r }));
    }
